        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Name ="sfrmEntry"
                    SourceObject ="Form.sfrm_DOCalibrationNew"
                    GridlineColor =10921638
                ...
                Begin Subform
                    ...
                    Height =8325
                    Name ="sfrmList"
                    SourceObject ="Form.sfrm_DOCalibrationList"
                    GridlineColor =10921638
                ...
                Begin Label
                    ...
                    ForeColor =8355711
                    Name ="Label269"
                    Caption ="Click on an item in the list to the left to view details. To add a new item to t"
                        "he list, click the \"Add New\" button at the bottom of this window."
                    GridlineColor =10921638
...
If Not IsNull(Me.OpenArgs) Then
    ...
    If Not IsNull(wqInstrID) Then
        ...
        Me.sfrmEntry.Form!txtBarometricPressure_mmHg.SetFocus
    End If
Else
